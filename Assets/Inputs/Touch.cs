...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Inputs/Touch.inputactions".
/// </summary>
/// <remarks>
...
public partial class @Touch: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Drawing"",
            ""id"": ""9571f112-680d-4ee2-917a-ae27787533c9"",
            ""actions"": [
                {
                    ""name"": ""Draw"",
                    ""type"": ""Button"",
                    ""id"": ""ca192edc-d3c1-450e-b44e-4503cae23ebe"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""7af7291b-4556-4648-b973-5ef906d136c3"",
                ...
                {
                    ""name"": """",
                    ""id"": ""b057327f-324b-46c3-a0a5-94bc74d7d92b"",
    ...
    ~@Touch()
    {
        UnityEngine.Debug.Assert(!m_Drawing.enabled, "This will cause a leak and performance issues, Touch.Drawing.Disable() has not been called.");
    }
    ...
    public struct DrawingActions
    {
        ...
        /// </summary>
        public DrawingActions(@Touch wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Drawing/Draw".
        /// </summary>
